...
def fieldwork_ready(connection: Any, project_id: str) -> dict[str, Any]:
    ...
    assessment = connection.execute("SELECT * FROM assessments WHERE project_id = ?", (project_id,)).fetchone()
    if assessment is None:
        blockers.append({"code": "assessment_missing", "detail": "Assessment is required"})
        return {"target": "fieldwork_ready_for_generation", "ready": False, "blockers": blockers, "informational": {"package": "not_applicable", "review": "not_applicable", "sign": "not_applicable", "backup": "not_applicable", "snapshot": "not_applicable"}}
    ...
    return {"target": "fieldwork_ready_for_generation", "ready": not blockers, "blockers": blockers, "informational": {"package": "not_applicable", "review": "not_applicable", "sign": "not_applicable", "backup": "not_applicable", "snapshot": "not_applicable"}}
