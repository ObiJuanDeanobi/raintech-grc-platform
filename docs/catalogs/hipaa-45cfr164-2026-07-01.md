...
3. **Section-level records.** The Breach Notification Rule labels nothing a standard, so its sections are the assessable unit. Check that reads correctly to you.

## Counts

| Catalog area | Standards | Implementation specifications | Sections | Required | Addressable | Total |
|---|---:|---:|---:|---:|---:|---:|
| Security Rule | 22 | 41 | 0 | 19 | 22 | 63 |
| Privacy Rule | 56 | 58 | 0 | 0 | 0 | 114 |
| Breach Notification Rule | 4 | 9 | 2 | 0 | 0 | 15 |
...
45 CFR 164.400-164.414 — subpart D. 15 records.
...
- [ ] **45 CFR 164.412** — Law enforcement delay
  ...
  - Note: Section-level record. This subpart publishes no "Standard:" label, so the section is the assessable unit. The section is a published, citable unit of the CFR; no structure is invented.
