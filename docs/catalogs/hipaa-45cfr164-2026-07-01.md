...
- [ ] **45 CFR 164.306 — Security standards: General rules**
  - Security standards: General rules. Governs how the other Security Rule records are assessed -- including the 164.306(d) addressable decision rule -- rather than stating a discrete assessable obligation. Its requirements are evaluated through the standards and implementation specifications it governs.
