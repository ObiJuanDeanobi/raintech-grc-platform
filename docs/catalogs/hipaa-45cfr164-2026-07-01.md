...
|---|---:|---:|---:|---:|---:|---:|
| Security Rule | 21 | 41 | 0 | 19 | 22 | 62 |
...
45 CFR 164.302-164.318 — subpart C. 62 records.
...
- [ ] **45 CFR 164.308(b)(3)** — Written contract or other arrangement (**Required**)
  - _Implementation specification_
  - Under: 45 CFR 164.308(a)(8) — Evaluation
...
- [ ] **Appendix A to Subpart C of Part 164**
  - Security Standards: Matrix. A summary restatement of the standards and implementation specifications in 164.308-164.316. Ingesting it would double-count every Security Rule record.
